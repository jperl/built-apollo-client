...
var ApolloClient = (function () {
    function ApolloClient(_a) {
        var _this = this;
        var _b = _a === void 0 ? {} : _a, networkInterface = _b.networkInterface, reduxRootKey = _b.reduxRootKey, reduxRootSelector = _b.reduxRootSelector, initialState = _b.initialState, dataIdFromObject = _b.dataIdFromObject, queryTransformer = _b.queryTransformer, resultTransformer = _b.resultTransformer, resultComparator = _b.resultComparator, _c = _b.ssrMode, ssrMode = _c === void 0 ? false : _c, _d = _b.ssrForceFetchDelay, ssrForceFetchDelay = _d === void 0 ? 0 : _d, _e = _b.mutationBehaviorReducers, mutationBehaviorReducers = _e === void 0 ? {} : _e;
...
},{"./core/QueryManager":4,"./data/storeUtils":10,"./fragments":13,"./queries/getFromAST":18,"./store":22,"./transport/networkInterface":23,"lodash.assign":31,"lodash.isstring":43,"lodash.isundefined":44}],2:[function(require,module,exports){
"use strict";
...
var ObservableQuery = (function (_super) {
    ...
    function ObservableQuery(_a) {
        ...
        this.refetch = function (variables) {
            ...
            var combinedOptions = assign({}, _this.options, {
                forceFetch: true,
            });
            return _this.queryManager.fetchQuery(_this.queryId, combinedOptions)
        ...
        this.updateQuery = function (mapFn) {
            var _a = _this.queryManager.getQueryWithPreviousResult(_this.queryId), previousResult = _a.previousResult, variables = _a.variables, document = _a.document;
...
},{"../util/Observable":24,"../util/errorHandling":25,"lodash.assign":31,"lodash.isequal":39}],4:[function(require,module,exports){
"use strict";
...
var QueryManager = (function () {
    function QueryManager(_a) {
        var _this = this;
        var networkInterface = _a.networkInterface, store = _a.store, reduxRootSelector = _a.reduxRootSelector, queryTransformer = _a.queryTransformer, resultTransformer = _a.resultTransformer, resultComparator = _a.resultComparator;
        this.idCounter = 0;
    ...
    QueryManager.prototype.getQueryParts = function (observableQuery) {
        ...
        if (this.queryTransformer) {
            transformedDoc = queryTransform_1.applyTransformers(transformedDoc, [this.queryTransformer]);
        }
        return {
    ...
    QueryManager.prototype.fetchRequest = function (_a) {
        ...
        var retPromise = new Promise(function (resolve, reject) {
            ...
            return _this.networkInterface.query(request)
                .then(function (result) {
                _this.store.dispatch({
...
},{"../data/readFromStore":6,"../errors/ApolloError":12,"../queries/getFromAST":18,"../queries/queryTransform":19,"../scheduler/scheduler":21,"../store":22,"../util/Observable":24,"../util/errorHandling":25,"./ObservableQuery":3,"graphql-tag/printer":30,"lodash.forown":35,"lodash.isequal":39}],5:[function(require,module,exports){
"use strict";
...
},{"../queries/getFromAST":18,"./replaceQueryResults":7,"./scopeQuery":8,"./writeToStore":11,"lodash.assign":31,"lodash.clonedeep":32,"lodash.mapvalues":45}],6:[function(require,module,exports){
"use strict";
...
var readStoreResolver = function (fieldName, objId, args, context) {
    ...
    var storeKeyName = storeUtils_1.storeKeyNameFromFieldNameAndArgs(fieldName, args);
    ...
    if (store_1.isJsonValue(fieldValue)) {
        return fieldValue.json;
    }
    if (store_1.isIdValue(fieldValue)) {
...
},{"../errors/ApolloError":12,"./store":9,"./storeUtils":10,"graphql-anywhere":28}],7:[function(require,module,exports){
"use strict";
var writeToStore_1 = require('./writeToStore');
var assign = require('lodash.assign');
...
},{"./writeToStore":11,"lodash.assign":31}],8:[function(require,module,exports){
"use strict";
var storeUtils_1 = require('./storeUtils');
...
},{"./storeUtils":10,"lodash.isnumber":41}],9:[function(require,module,exports){
"use strict";
...
function data(previousState, action, queries, mutations, config) {
    ...
    if (actions_1.isQueryResultAction(action)) {
        ...
        if (!storeUtils_1.graphQLResultHasError(action.result)) {
            ...
            var newState = writeToStore_1.writeResultToStore({
...
},{"../actions":2,"./mutationResults":5,"./replaceQueryResults":7,"./storeUtils":10,"./writeToStore":11,"lodash.assign":31,"lodash.isobject":42}],10:[function(require,module,exports){
"use strict";
...
function writeSelectionSetToStore(_a) {
    ...
    readFromStore_1.handleFragmentErrors(fragmentErrors);
    return store;
}
...
},{"../errors/ApolloError":12,"../queries/directives":17,"../queries/getFromAST":18,"./readFromStore":6,"./store":9,"./storeUtils":10,"lodash.assign":31,"lodash.isnull":40,"lodash.isobject":42,"lodash.isundefined":44}],12:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"./queries/getFromAST":18,"lodash.flatten":34}],14:[function(require,module,exports){
"use strict";
var networkInterface_1 = require('./transport/networkInterface');
...
},{"./ApolloClient":1,"./core/ObservableQuery":3,"./data/readFromStore":6,"./data/writeToStore":11,"./errors/ApolloError":12,"./fragments":13,"./queries/getFromAST":18,"./queries/queryTransform":19,"./store":22,"./transport/networkInterface":23,"graphql-tag/printer":30}],15:[function(require,module,exports){
"use strict";
var actions_1 = require('../actions');
var assign = require('lodash.assign');
...
},{"../actions":2,"lodash.assign":31}],16:[function(require,module,exports){
"use strict";
var actions_1 = require('../actions');
...
},{"../actions":2,"../data/store":9,"../store":22,"lodash.assign":31,"lodash.pick":47}],17:[function(require,module,exports){
"use strict";
...
},{"lodash.assign":31,"lodash.countby":33,"lodash.identity":36}],19:[function(require,module,exports){
"use strict";
...
},{"./getFromAST":18,"lodash.clonedeep":32}],20:[function(require,module,exports){
"use strict";
var actions_1 = require('../actions');
var storeUtils_1 = require('../data/storeUtils');
var assign = require('lodash.assign');
...
},{"../actions":2,"../data/storeUtils":10,"lodash.assign":31,"lodash.isequal":39}],21:[function(require,module,exports){
"use strict";
var ObservableQuery_1 = require('../core/ObservableQuery');
var assign = require('lodash.assign');
...
},{"../core/ObservableQuery":3,"lodash.assign":31}],22:[function(require,module,exports){
"use strict";
...
},{"./data/store":9,"./mutations/store":15,"./optimistic-data/store":16,"./queries/store":20,"lodash.assign":31,"redux":58}],23:[function(require,module,exports){
"use strict";
var isString = require('lodash.isstring');
var assign = require('lodash.assign');
var mapValues = require('lodash.mapvalues');
...
},{"graphql-tag/printer":30,"lodash.assign":31,"lodash.isstring":43,"lodash.mapvalues":45,"whatwg-fetch":63}],24:[function(require,module,exports){
"use strict";
...
},{"symbol-observable":60}],25:[function(require,module,exports){
"use strict";
...
},{"lodash.assign":31,"lodash.countby":33,"lodash.identity":36}],28:[function(require,module,exports){
"use strict";
var getFromAST_1 = require('./getFromAST');
...
},{"./directives":26,"./getFromAST":27,"./storeUtils":29,"lodash.isarray":38,"lodash.isnull":40,"lodash.isundefined":44,"lodash.merge":46}],29:[function(require,module,exports){
"use strict";
...
},{"lodash.includes":37}],30:[function(require,module,exports){
module.exports =
